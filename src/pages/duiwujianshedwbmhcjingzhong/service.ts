...
export async function informationrule(
  ...
  return request<{
    ...
    total?: number;
    success?: boolean;
  }>('/duiwujianshe/api/dwbmhcjingzhonginformationrule', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function dwzcupdateinformationRule(data: { [key: string]: any }, options?: { [key: string]: any }) {
  return request<TableListItem>('/duiwujianshe/api/dwbmhcjingzhongdwzcinformationrule', {
    data,
    method: 'PUT',
    ...(options || {}),
  });
...
export async function jzfhupdateinformationRule(data: { [key: string]: any }, options?: { [key: string]: any }) {
  return request<TableListItem>('/duiwujianshe/api/dwbmhcjingzhongjzfhinformationrule', {
    data,
    method: 'PUT',
    ...(options || {}),
  });
