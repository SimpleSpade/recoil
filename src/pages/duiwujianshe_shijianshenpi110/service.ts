...
export async function informationrule(
  ...
  return request<{
    ...
    total?: number;
    success?: boolean;
  }>('/duiwujianshe/api/shijianshenpiinformationrule', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function updateinformationRule(data: { [key: string]: any }, options?: { [key: string]: any }) {
  return request<TableListItem>('/duiwujianshe/api/shijianshenpiquerenshenpiinformationrule', {
    data,
    method: 'PUT',
    ...(options || {}),
  });
...
export async function shijianluruxialakuanginformationrule(
  ...
  return request<{}>('/duiwujianshe/api/shijianshenpixialakuanginformationrule', {
    method: 'GET',
    params: {
      // ...params,
    },
