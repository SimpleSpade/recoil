...
export async function informationrule(
  ...
  return request<{
    ...
    total?: number;
    success?: boolean;
  }>('/duiwujianshe/api/rcddglinformationrule', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function updateinformationRule(data: { [key: string]: any }, options?: { [key: string]: any }) {
  return request<TableListItem>('/duiwujianshe/api/rcddglbianjiinformationrule', {
    data,
    method: 'PUT',
    ...(options || {}),
  });
...
export async function getrcddgluuid(data: { [key: string]: any }, options?: { [key: string]: any }) {
  return request<TableListItem>('/duiwujianshe/api/getrcddgluuid', {
    data,
    method: 'get',
    ...(options || {}),
  });
