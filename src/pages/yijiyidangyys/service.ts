...
export async function informationrule(
  ...
  return request<{
    ...
    total?: number;
    success?: boolean;
  }>('/yijiyidang/api/informationrule', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function updateinformationRule(data: { [key: string]: any }, options?: { [key: string]: any }) {
  return request<TableListItem>('/yijiyidang/api/informationrule', {
    data,
    method: 'PUT',
    ...(options || {}),
  });
...
export async function removeRule(data: { key: number[] }, options?: { [key: string]: any }) {
  return request<Record<string, any>>('/yijiyidang/api/informationrule', {
    data,
    method: 'DELETE',
    ...(options || {}),
  });
