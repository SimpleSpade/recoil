...
const TableListzsgc: React.FC = () => {
  ...
  const columns: ProColumns<TableListItem>[] = [
    ...
    // },
    {
      ...
      render: (_, record) => [
        <Button
          disabled={record.spzt === '审批中' ? true : record.qrzt === '待确认' ? true : false}
          type={"primary"}
          key="config"
          onClick={() => {
