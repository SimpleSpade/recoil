...
export async function informationrule(
  ...
  return request<{
    ...
    total?: number;
    success?: boolean;
  }>('/duiwujianshe/api/shijianchakanzhuanguaninformationrule', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function updateinformationRule(data: { [key: string]: any }, options?: { [key: string]: any }) {
  return request<TableListItem>('/duiwujianshe/api/shijianchakanquerenshenpiinformationrule', {
    data,
    method: 'PUT',
    ...(options || {}),
  });
...
export async function huituiRule(data: { [key: string]: any }, options?: { [key: string]: any }) {
  return request<TableListItem>('/duiwujianshe/api/huituiinformationrule', {
    data,
    method: 'PUT',
    ...(options || {}),
  });
...
export async function shijianshenpixialakuanginformationrule(
  ...
  return request<{}>('/duiwujianshe/api/shijianchakanxialakuanginformationrule', {
    method: 'GET',
    params: {
      // ...params,
    },
