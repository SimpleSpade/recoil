        ...
        <ProForm.Group>
          ...
          >
            <ProFormGroup key="group">
              <ProFormDigit width={80} name="xh" label="序号" min={1}
                            rules={[
                              {
                                required: true,
                                message: '请输入序号！',
              ...
              />
              <ProFormText width={150} name="jksbmc" label="监控设备名称"
                           rules={[
                             {
                               required: true,
                               message: '请输入监控设备名称！',
              ...
              <ProFormText width={150} name="jpbh" label="键盘编号（9位）"
                           rules={[{max: 9, min: 9, message: '请输入9位键盘编号', required: true}]}/>
              <ProFormSelect
                width={150}
                rules={[
                  {
