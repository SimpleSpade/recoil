...
export async function informationrule(
  ...
  return request<{
    ...
    total?: number;
    success?: boolean;
  }>('/duiwujianshe/api/wtczinformationrule', {
    method: 'GET',
    params: {
      ...params,
    },
...
/** 新建规则 PUT /api/rule */
export async function wtczupdateinformationRule(data: { [key: string]: any }, options?: { [key: string]: any }) {
  return request<TableListItem>('/duiwujianshe/api/wtczinformationrule', {
    data,
    method: 'PUT',
    ...(options || {}),
  });
...
export async function jzfhupdateinformationRule(data: { [key: string]: any }, options?: { [key: string]: any }) {
  return request<TableListItem>('/duiwujianshe/api/wtczjzfhinformationrule', {
    data,
    method: 'PUT',
    ...(options || {}),
  });
