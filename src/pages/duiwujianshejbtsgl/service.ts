...
export async function informationrule(
  ...
  return request<{
    ...
    total?: number;
    success?: boolean;
  }>('/duiwujianshe/api/jbtsglinformationrule', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function updateinformationRule(data: { [key: string]: any }, options?: { [key: string]: any }) {
  return request<TableListItem>('/duiwujianshe/api/jbtsglbianjiinformationrule', {
    data,
    method: 'PUT',
    ...(options || {}),
  });
...
export async function getjbtsgluuid(data: { [key: string]: any }, options?: { [key: string]: any }) {
  return request<TableListItem>('/duiwujianshe/api/getjbtsgluuid', {
    data,
    method: 'get',
    ...(options || {}),
  });
...
export async function addinformationRule(data: { [key: string]: any }, options?: { [key: string]: any }) {
  return request<TableListItem>('/duiwujianshe/api/jbtsglinformationrule', {
    data,
    method: 'POST',
    ...(options || {}),
  });
